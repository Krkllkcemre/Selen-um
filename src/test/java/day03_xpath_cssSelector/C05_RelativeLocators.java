...
public class C05_RelativeLocators
{
    public static void main(String[] args)
    {
        ...
        Olur da bir elementi locate edemezseniz 2 şey ile o elementi
        locate edebilirsiniz
                1- Etrafından bir web element(sag,sol,ust,altında veya yakınında)
                2-locate edemediginiz webElement'e özellik (tag,attribute)
         */
